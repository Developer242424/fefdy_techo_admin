...
// Middleware to strip cookies from incoming requests
app.use((req, res, next) => {
  req.cookies = {}; // If you're using cookie-parser, this prevents use
  req.headers.cookie = ''; // Remove raw header
  next();
});

app.get('/', (req, res) => {
  res.send('Cookies and caching are disabled');
});
