...
router.post("/get-topics-by-subjects-for-drop", HandlerController.getTopicBySubjectForDrop);
router.post("/get-level-count-for-drop", HandlerController.getLevelCountForDrop);
...
router.get("/question_type", (req, res) => {
  return res.render("admin/layout", {title: "Question Type", content: "../admin/question_type/index", url: req.originalUrl, baseurl: "/admin", homeurl: "/admin/dashboard"});
});

router.get("/question_list", (req, res) => {
  return res.render("admin/layout", {title: "Question List", content: "../admin/question_list/index", url: req.originalUrl, baseurl: "/admin", homeurl: "/admin/dashboard"});
});
