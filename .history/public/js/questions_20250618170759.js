    ...
    $.ajax({
      ...
      success: async function (res) {
        if (res.status === 200) {
          const data = res.data;
          if (type === 1 || type === "1") {
            let ques_html_cho = makeHTMLforChooseUp(data.data);
            $(".choose_questions_container").html(ques_html_cho);
            OpenModal("question_list_edit_modal");
          } else if (type === 2 || type === "2") {
            let ques_html_mat = makeHTMLforMatchUp(data.data);
            $(".choose_questions_container").html(ques_html_mat);
...
function makeHTMLforChooseUp(data) {
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="form-group">
                                <label for="edit_subject"><input type="checkbox" ${
                                  data.option.option_a.is_answer
                                    ? "checked"
                                    : ""
                                } class="limit-checkbox"> Option
                                    A</label>
                                <textarea class="form-control" rows="1">${
                                  data.option.option_a.text
                                }</textarea>
                                <p class="validate_error text-danger" id="edit_subject_error"></p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="thumbnail-box" onclick="this.querySelector('input[type=file]').click();">
                                    <i class="material-icons">image</i>
                                    <img class="thumbnail-preview-img" src="../${
                                      data.option.option_a.thumbnail ?? ""
                                    }">
                                    <input type="file" class="thumbnail-input" accept="image/*" style="display:none;"
                                        onchange="previewThumbnail(this)">
                                </div>
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="form-group">
                                <label for="edit_subject"><input type="checkbox" ${
                                  data.option.option_b.is_answer
                                    ? "checked"
                                    : ""
                                } class="limit-checkbox"> Option
                                    B</label>
                                <textarea class="form-control" rows="1">${
                                  data.option.option_b.text
                                }</textarea>
                                <p class="validate_error text-danger" id="edit_subject_error"></p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="thumbnail-box" onclick="this.querySelector('input[type=file]').click();">
                                    <i class="material-icons">image</i>
                                    <img class="thumbnail-preview-img" src="../${
                                      data.option.option_b.thumbnail ?? ""
                                    }">
                                    <input type="file" class="thumbnail-input" accept="image/*" style="display:none;"
                                        onchange="previewThumbnail(this)">
                                </div>
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="form-group">
                                <label for="edit_subject"><input type="checkbox" ${
                                  data.option.option_c.is_answer
                                    ? "checked"
                                    : ""
                                } class="limit-checkbox"> Option
                                    -3</label>
                                <textarea class="form-control" rows="1">${
                                  data.option.option_c.text
                                }</textarea>
                                <p class="validate_error text-danger" id="edit_subject_error"></p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="thumbnail-box" onclick="this.querySelector('input[type=file]').click();">
                                    <i class="material-icons">image</i>
                                    <img class="thumbnail-preview-img" src="../${
                                      data.option.option_c.thumbnail ?? ""
                                    }">
                                    <input type="file" class="thumbnail-input" accept="image/*" style="display:none;"
                                        onchange="previewThumbnail(this)">
                                </div>
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="form-group">
                                <label for="edit_subject"><input type="checkbox" ${
                                  data.option.option_d.is_answer
                                    ? "checked"
                                    : ""
                                } class="limit-checkbox"> Option
                                    -4</label>
                                <textarea class="form-control" rows="1">${
                                  data.option.option_d.text
                                }</textarea>
                                <p class="validate_error text-danger" id="edit_subject_error"></p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="thumbnail-box" onclick="this.querySelector('input[type=file]').click();">
                                    <i class="material-icons">image</i>
                                    <img class="thumbnail-preview-img" src="../${
                                      data.option.option_d.thumbnail ?? ""
                                    }">
                                    <input type="file" class="thumbnail-input" accept="image/*" style="display:none;"
                                        onchange="previewThumbnail(this)">
                                </div>
