...
let publicURL = "https://feboo.fefdybraingym.com/public/";
...
function loadQuestion() {
  ...
  questionContainer.innerHTML = `
        ...
        <img src="${publicURL+question.image}" alt="question image" style="display:${question.image ? "block" : "none"}" class="question-image">
  ...
  question.options.forEach((option, index) => {
    ...
    optionDiv.innerHTML = `
            <img src="${publicURL+option.image}" style="display:${option.image !== "" ? "block" : "none"}" alt="${option.text}" class="option-image">
