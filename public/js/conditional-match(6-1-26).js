  ...
  setTimeout(() => {
    ...
    setTimeout(() => {
      ...
      if (correctCount === totalQuestions) {
        // All correct - show success modal automatically
        showSuccessModal();
      } else if (isRetryMode) {
        // If retry modal was shown before, show start again modal instead
        showStartAgainModal(correctCount, totalQuestions);
      } else {
        // Show retry modal for normal attempts
...
function showStartAgainModal(correctCount, totalQuestions) {
  // If score is 0, show the minimum score modal instead
  if (correctCount === 0) {
    showRetryModal(correctCount, totalQuestions);
    return;
  }
