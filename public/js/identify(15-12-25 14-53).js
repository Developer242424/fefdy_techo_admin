...
function notifySuccess() {
  ...
  document.getElementById("time-display").textContent = "Time taken : " + timeTaken;
  document.getElementById("score-display").textContent = cumulativeScore + " points";

  document.getElementById("question-frame").style.display = "none";
  document.getElementById("success-modal").classList.add("show");

  document.body.style.background = "url('/choose/game-bg.png') no-repeat center center";
  document.body.style.backgroundColor = "transparent";
