...
function restartIncompleteDrag(adjX, adjY) {
  ...
  const fromDot = tempDrag.fromDot;
  const cardWrapper = fromDot.closest(".match-card-wrapper");

  resumeDragFrom(tempDrag.x, tempDrag.y, fromDot);
}
...
function completeTest() {
  ...
  const ttl_questions = matchQuestions.length - 1;
