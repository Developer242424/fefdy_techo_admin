...
function loadQuestion() {
  ...
  // Filter cards: if in retry mode, show only wrong cards
...
function handleDrop(e, categoryIndex) {
  ...
  setTimeout(() => {
    ...
    if (remainingCards === 0) {
      ...
      // If in retry mode, show start again modal
      if (isRetryMode) {
        setTimeout(() => showStartAgainModal(), 500);
      } else {
        // First attempt, show retry modal
